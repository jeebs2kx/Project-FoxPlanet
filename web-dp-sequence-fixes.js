...
function patchRuntime(rt){
  ...
  // The desktop build's face track reaches the jaw during its final pose pass.
  // Some browser-created DP model instances lose that final jaw write. Track the
  // real pose writes and only add the jaw rotation if that final write was absent.
